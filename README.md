...
**Full Stack Developer** @ **SEDS Tech** *(Nov 2025 – Feb 2026)*
- Engineered backend systems for E-commerce & Project Management platforms with authentication, real-time updates, and automated task allocation
- Designed REST API endpoints and optimized database structures for business logic requirements
- Developed frontend components for **CredoTracker** from Figma designs with seamless backend integration
